...
const EditFeatures = () => {
    ...
    const getDropList = (item, data) => {
        if (!data) return []; // Add a safeguard here
        if (item === "bidTimeList") {
                        ...
                        <div className="row">
                            <form className='col-md-12 d-flex flex-wrap' onSubmit={removeFeature}>
                                ...
                                {itemRemove &&
                                    <div className="col-md-5">
                                        <div className="form-group m-0">
                                            <label className="form-label text-dark">Select Item to Remove</label>
                            ...
                            <form className='col-md-12 d-flex flex-wrap' onSubmit={updatePackage}>
                                ...
                                {newPackage &&
                                    <div className="col-md-9 mt-5">
                                        <div className="form-group m-0">
                                            <label className="form-label text-dark">New Description (Comma separated)</label>
